...
namespace McenterLite.Shared.Tests
{
    public class PipeEnvelopeTests
    {
        ...
        {
            var parsed = RoundTrip(PipeEnvelope.Failure(7, Function.HwMouseMode, "not present"));
        ...
        {
            var parsed = RoundTrip(new PipeEnvelope(3, Command.Set, Function.HwMouseMode, payload));
        ...
        {
            var payload = "a\u0001b\u001fc";
            var wire = new PipeEnvelope(1, Command.Set, Function.HwMouseMode, payload).Serialize();
        ...
        public void Serialize_ProducesSingleLine()
        {
            ...
            var wire = new PipeEnvelope(1, Command.Set, Function.HwMouseMode, "a\nb\r\nc").Serialize();
            Assert.Equal(-1, wire.IndexOf('\n'));
